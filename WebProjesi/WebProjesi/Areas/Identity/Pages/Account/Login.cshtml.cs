...
namespace WebProjesi.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly UserManager<WebProjesiKullanici> _userManager1;
        private readonly SignInManager<WebProjesiKullanici> _signInManager;
        private readonly ILogger<LoginModel> _logger;

        public LoginModel(SignInManager<WebProjesiKullanici> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("kullaniciFilmler", "Film", new { area = "" });
                    }
